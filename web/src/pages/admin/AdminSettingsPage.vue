  ...
  <AdminLayout title="系统设置" description="配置站点基础信息、评论策略、邮件服务、安全和备份。" mobile-title="系统设置" primary-action="保存">
    <template #actions>
      <div class="header-actions">
        <button class="button-secondary" type="button" @click="load">恢复默认</button>
    ...
    <section v-if="settings" class="settings-grid">
      ...
      <section class="panel">
        ...
        <div class="settings-stack">
          ...
          <label class="setting-row"><div><strong>评论自动审核</strong><div class="meta-row"><span>新评论默认进入待审核</span></div></div><input v-model="settings.autoApproveComments" type="checkbox"></label>
      ...
      <section class="panel">
        ...
        <div class="settings-stack">
          ...
          <label class="setting-row"><div><strong>投稿必须人工审核</strong><div class="meta-row"><span>通过后才进入公开文章列表</span></div></div><input v-model="settings.submissionManualReview" type="checkbox"></label>
